...
public class TransferTests extends BaseTest {
    ...
    public void testSuccessfulTransfer() {
        ...
        logger.info("TC_002 PASSED: Transfer from {} to {}", fromAccount, toAccount);
    }
    ...
    public void testInsufficientBalance() {
        ...
        String toAccount = dashboard.getAccountWithHighestBalance();
        ...
        logger.info("TC_003 PASSED: Insufficient balance test");
    }
    ...
    public void testInvalidRecipient() {
        ...
        assertThat(isError || isSuccess).isTrue();
        logger.info("TC_004 PASSED: Invalid recipient test");
    }
